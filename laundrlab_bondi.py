...
TARGET_URL = os.getenv("TARGET_URL", "https://wa.sqinsights.com/182471?room=6190")
REFERER_URL = os.getenv("REFERER_URL", "https://laundrlab.com.au/live-status-bondi/")
...
# New: configurable location label (defaults to 'Bondi')
LOCATION = os.getenv("LOCATION", "Bondi")
