...
TARGET_URL = os.getenv("TARGET_URL", "https://wa.sqinsights.com/182471?room=11976")
REFERER_URL = os.getenv("REFERER_URL", "https://laundrlab.com.au/live-status-balmain/")
...
# New: configurable location label (defaults to 'Balmain')
LOCATION = os.getenv("LOCATION", "Balmain")

DATA_DIR = Path(__file__).resolve().parent / "data"
DATA_DIR.mkdir(exist_ok=True)
DEBUG_CSV = DATA_DIR / "soapranos_balmain_status.csv"
